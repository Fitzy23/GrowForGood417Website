    ...
    <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
        ...
        <form action="../controller/login.php" method="POST" class="space-y-3">
            <div>
                ...
                <input type="username" name="email" id="username" required class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
            </div>
            <div>
